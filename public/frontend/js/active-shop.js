...
$(document).ready(function() {
    ...
    if ($('.countdown').length > 0) {
        $('.countdown').each(function() {
            ...
            $this.countdown(date).on('update.countdown', function(event) {
                var $this = $(this).html(event.strftime('' +
                    '<p class="countdown-item"><span class="countdown-digit">%-D</span><span class="countdown-label countdown-days"> Ngày </span></p>' +
                    '<p class="countdown-item"><span class="countdown-digit">%H</span><span class="countdown-separator">:</span><span class="countdown-label"> Giờ</span></p>' +
                    '<p class="countdown-item"><span class="countdown-digit">%M</span><span class="countdown-separator">:</span><span class="countdown-label"> Phút</span></p>'+
                    '<p class="countdown-item"><span class="countdown-digit">%S</span><span class="countdown-label"> Giây</span></p>'
                ));
            });
        });
    }
