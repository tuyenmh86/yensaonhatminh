                                ...
                                <div class="form-box-content p-3">
                                   ...
                                   <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    <select class="form-control mb-3 selectpicker" data-placeholder="Chọn tỉnh" name="province" id="province">
                                                        @foreach (\App\Province::all() as $key => $province)
                                                            <option value="{{ $province->id }}" <?php if($shop->province == $province->id) echo "selected";?> >{{ $province->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <select class="form-control selectpicker" name="district" id="districts">
                                                    @foreach (\App\District::all() as $key => $district)
                                                        <option value="{{ $district->id }}" <?php if($shop->district == $district->id) echo "selected";?> >{{ $district->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <select class="form-control selectpicker" name="ward" id="ward">
                                                    @foreach (\App\Ward::all() as $key => $ward)
                                                        <option value="{{ $ward->id }}" <?php if($shop->wards == $ward->id) echo "selected";?> >{{ $ward->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Số nhà/Đường" name="address" value="{{ $shop->address }}" required>
                                        </div>
                                     </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Your Phone Number" name="phone" value="{{ $shop->phone }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Your Zalo Number" name="zalo" value="{{ $shop->zalo }}">
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="long latitude" name="long" value="{{ $shop->long }}">
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="lat latitude" name="lat" value="{{ $shop->lat}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="chính sách đổi trả" name="policy" value="{{ $shop->policy}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Ship Code" name="policy" value="{{ $shop->payment}}">
                                        </div>
                                    </div>
