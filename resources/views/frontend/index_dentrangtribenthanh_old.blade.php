...
@section('content')
{{--    <section class="home-banner-area mb-4 bg-white">--}}
{{--        <div class="container">--}}
    ...
    <section class="mb-4">
        <div class="container">
            <div class="p-4 bg-white shadow-sm">
                ...
                <div class="caorusel-box">
                    <div class="slick-carousel" data-slick-items="5" data-slick-xl-items="5" data-slick-lg-items="5"  data-slick-md-items="5" data-slick-sm-items="2" data-slick-xs-items="2">
                        @foreach (\App\Product::where('published', 1)->where('featured', '1')->get() as $key => $product)
                            <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-3">
                                        <div class="price-box">
                                            @if($product->unit_price>0)
                                                ...
                                                @endif
{{--                                                <span class="product-price strong-600">{{ home_discounted_base_price($product->id) }}</span>--}}
                                                <span class="product-price strong-600">{{format_price(convert_price($product->unit_price )) }}</span>
{{--                                                <span class="product-price strong-600">{{ home_discounted_base_price($product->id) }}</span>--}}
                                            @else
                                                <span class="product-price strong-600">Liên hệ</span>
                                            @endif
...
--}}
    ...
    @foreach (\App\Category::where('featured', 1)->get() as $homeCategory)
        <section class="mb-4">
            <div class="container">
                <div class="p-4 bg-white shadow-sm">
                    <div class="section-title-1 clearfix">
                    ...
                    <div class="caorusel-box">
                        <div class="slick-carousel" data-slick-items="5" data-slick-xl-items="5" data-slick-lg-items="5"  data-slick-md-items="5" data-slick-sm-items="2" data-slick-xs-items="2">
                          @foreach (filter_products(\App\Product::where('published', 1)->where('category_id', $homeCategory->id))->get() as $key => $product)
                                <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                    <div class="card-body p-0">
        ...
        <section class="mb-4">
            <div class="container">
                <div class="p-4 bg-white shadow-sm">
                    <div class="section-title-1 clearfix">
                        <h3 class="heading-5 strong-700 mb-0 float-left">
                            <span class="mr-4">{{ \App\SubCategory::find($subcategory)->name }}</span>
                        </h3>
                    </div>
                    <div class="caorusel-box">
                        <div class="slick-carousel" data-slick-items="3" data-slick-xl-items="3" data-slick-lg-items="3"  data-slick-md-items="3" data-slick-sm-items="1" data-slick-xs-items="1">
                            @foreach (filter_products(\App\Product::where('published', 1)->where('subcategory_id', $subcategory))->limit(6)->get() as $key => $product)
                                <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                    <div class="card-body p-0">
