		...
		<div class="row">
			<div class="col-lg-2 col-xl-3 col-md-3 col-6 col-logo">
				...
				<a href="{{route('home')}}" class="logo">
					...
					<h1 class="title" style="font-size: 1rem">CHỔI ĐÓT THẠNH HOÀ</h1>
				</a>

			</div>
			
			<div class="col-lg-9 col-xl-8 col-md-5 col-10 col-search order-3 order-md-2">
				
				<div class="theme-search-smart">
					<div class="header_search theme-searchs">
							<svg class="menumobilebutton category-action" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
								id="iconcate-action" x="0px" y="0px" viewBox="0 0 384.97 384.97"
						...
						<form action="{{ route('search') }}" method="GET" class="input-group search-bar theme-header-search-form ultimate-search"
							role="search">
							<input type="search" id="search" name="q" value="" placeholder="Bạn cần tìm gì hôm nay... " class="input-group-field st-default-search-input search-text search_md" autocomplete="off" required="">
							...
							{{-- <div class="search-keys">
								<ul class="inline-links d-none d-lg-block d-md-block">
									@foreach (\App\Search::orderBy('count', 'desc')->get()->take(3) as $key => $search)
										<li class="nav-item">
				...
				<div class="contact-phone">
					...
					<a href="tel:{{\App\GeneralSetting::first()->phone}}">{{\App\GeneralSetting::first()->phone}}</a>
				</div>
						...
						<div class="icon">
							<a href="/yeu-thich" class="wishlist_header" title="Sản phẩm yêu thích">
								<svg enable-background="new 0 0 412.735 412.735" version="1.1"
									viewBox="0 0 412.74 412.74" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
									<path
						...
						<div class="icon">
							<a class="img_hover_cart" href="#" title="Giỏ hàng">
								<svg enable-background="new 0 0 407.453 407.453" version="1.1"
									viewBox="0 0 407.45 407.45" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
									<g fill="#010002">
										<path
								...
								@if(Session::has('cart'))
								<span class="nav-box-number cart_items_sidenav">{{ count(Session::get('cart'))}}</span>
								@else
									<span class="nav-box-number cart_items_sidenav">0</span>
									<span id="cart_items_sidenav cart_items_sidenav">0</span>
								@endif
							</a>
						</div>
						<div class="top-cart-content">
							<div id="cart_items" class="CartHeaderContainer">
