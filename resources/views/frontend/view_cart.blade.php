            ...
            <div class="row cols-delimited">
                ...
                <div class="col-4">
                    <div class="icon-block icon-block--style-1-v5 text-center">
                        ...
                        <div class="block-content d-none d-md-block">
                            <h3 class="heading heading-sm strong-300 c-gray-light text-capitalize">2. Tiếp tục thanh toán</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-default bg-white p-4">
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1">Thông tin vận chuyển</a>
{{--                                @if(Auth::check())--}}
{{--                                    <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1">Thông tin thanh toán</a>--}}
{{--                                @else--}}
