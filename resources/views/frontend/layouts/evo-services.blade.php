...
<head>
    ...
    @yield('meta')
    <link name="favicon" type="image/x-icon" href="{{ asset($sitesetting->favicon) }}"
          rel="shortcut icon"/>
...
{{--          rel="stylesheet">--}}
    ...
    <link rel="canonical" href="{{$sitesetting->address}}"/>
    <meta name='revisit-after' content='{{$seosetting->revisit}} days'/>
    <meta name="theme-color" content="#59ca6d"/>
    <link rel="apple-touch-icon" href="{{ asset($sitesetting->favicon) }}">
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{$sitesetting->site_name}}">
    <meta property="og:image"
      content="{{asset($sitesetting->logo)}}">
    <meta property="og:image:secure_url"
          content="{{asset($sitesetting->logo)}}">
    <meta property="og:description" content="{{$seosetting->description}}">
    <meta property="og:url" content="{{$sitesetting->description}}">
    <meta property="og:site_name" content="{{$sitesetting->site_name}}">


    <!-- Icons -->
    <link type="text/css" href="{{ asset('frontend/evo/css/main.scss.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('frontend/evo/css/evo-index.scss.css') }}" rel="stylesheet">
    ...
    <link type="text/css" href="{{ asset('frontend/css/hotline.css') }}" rel="stylesheet">
    @yield('style')
    <!-- Global style (main) -->
    ...
    <script src={{ asset('frontend/js/vendor/jquery.lazyload.min.js') }}"></script>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type" : "Organization",
        "legalName" : "{{$sitesetting->site_name}}",
        "url" : "{{$sitesetting->address}}",
        "contactPoint":[{
            "@type" : "ContactPoint",
            "telephone" : "{{$sitesetting->phone}}",
            "contactType" : "customer service"
        }],
        "logo":"{{asset($sitesetting->logo)}}",
        "sameAs":[
        "#",
        "#"
        ]
    ...
    <script type="application/ld+json">
    {
      ...
      "potentialAction":{
            "@type" : "SearchAction",
            "target" : "{{$sitesetting->address}}/search?q={search_term}",
...
<!-- MAIN WRAPPER -->
<body class="index">
{{--@include('frontend.inc.evo-service.seachbar')--}}
@include('frontend.inc.evo-service.header')
{{--@include('frontend.inc.nav')--}}
<div class="evo-themes">
    {{--    <h1 class="d-none">Evo Services</h1>--}}
    @yield('content')
</div>
{{--[footer-evo]--}}
@include('frontend.inc.evo-service.evo_footer')
...
{{--    --}}
    ...
    <script src="{{ asset('frontend/evo/js/main.js') }}"></script>
