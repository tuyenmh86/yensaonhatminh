...
{{--                                    @foreach (\App\Category::where('parent_id',$parent_id)->get() as $key => $category)--}}
...
{{--                                                @foreach ($category->children as $key2 => $subcategory)--}}
...
{{--                                                            <a href="{{ route('products.category', $subcategory->id) }}">{{ __($subcategory->name)}} </a>--}}
{{--                                                        </button>--}}
{{--                                                        <div id="subCategory-{{ $key }}-{{ $key2 }}" class="collapse">--}}
{{--                                                            <ul class="sub-sub-category-list">--}}
{{--                                                                @foreach ($subcategory->children as $key3 => $subsubcategory)--}}
{{--                                                                    <li><a href="{{ route('products.category', $subsubcategory->id) }}">{{ __($subsubcategory->name) }}</a></li>--}}
{{--                                                                @endforeach--}}
{{--                                                            </ul>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
...
{{--                                            @foreach (\App\Category::find($category_id)->children as $key => $subcategory)--}}
...
{{--                                                <button class="btn-quickview" onclick="showAddToCartModal({{ $product->id }})"><i class="la la-eye"></i></button>--}}
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <div class="price-box">
                                                    ...
                                                    @else
                                                        <span class="product-price strong-300"><strong>Liên hệ</strong></span>
                                                    @endif
...
{{--                                                    </button>--}}
                                                    ...
                                                    <button type="button" class="paction add-cart btn btn-base-1 btn-icon-left" onclick="showAddToCartModal({{ $product->id }})">
                                                        <i class="fa la la-shopping-cart mr-0 mr-sm-2"></i><span class="d-sm-inline-block">{{__('Add to cart')}}</span>
                                                    </button>
