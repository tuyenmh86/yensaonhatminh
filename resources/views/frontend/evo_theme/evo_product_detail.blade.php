                ...
                <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-description-wrapper">
                                    ...
                                    <ul class="inline-links inline-links--style-1">
                                        ...
                                        @if(count(json_decode($product->variations, true)) >= 1)
                                            @if ($qty > 0)
                                                <li>
                                                    <span
                                                        class="badge badge-md badge-pill bg-green">{{__('In stock')}}</span>
                                                </li>
                                            @else
                                                <li>
                                                    <span
                                                        class="badge badge-md badge-pill bg-red">{{__('Out of stock')}}</span>
                                                </li>
                                            @endif
                                        @endif
                                    </ul>
                            ...
                            {{--                                </div>--}}
                            {{--                                <div class="col-sm-6">--}}
                            {{--                                    <a class="btn btn-big btn-seller" href="tel:0932104104">--}}
                            {{--                                        <span>Phụ trách kinh doanh</span>--}}
                            {{--                                        <span class="info-text">{{$sitesetting->phone}} </span>--}}
                            {{--                                    </a>--}}
                            {{--                                </div>--}}
                            {{--                            </div>--}}
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    @if(count(json_decode($product->variations, true)) >= 1)
                                        @if ($qty > 0)
                                            <button type="button"
                                                    class="btn btn-styled btn-base-1 btn-icon-left strong-700 hov-bounce hov-shaddow"
                                                    onclick="buyNow()">
                                ...
                                <!-- Add to cart button -->
                                    <button type="button"
                                            class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2"
                                            onclick="addToCart()">
                                        <i class="la la-shopping-cart"></i>
                                        <span class="d-none d-md-inline-block"> Mua khóa học</span>
                                    </button>
                                </div>
                            </div>
                            ...
                            {{--                            <div class="row no-gutters mt-3">--}}
                            {{--                                <div claproduct-galss="col-2">--}}
                            {{--                                    <div class="product-description-label alpha-6">{{__('Return Policy')}}:</div>--}}
                            {{--                                </div>--}}
                            {{--                                <div class="col-10">--}}
                            {{--                                    {{__('Returns accepted if product not as described, buyer pays return shipping fee; or keep the product & agree refund with seller.')}}--}}
                            {{--                                    <a href="{{ route('returnpolicy') }}" class="ml-2">View details</a>--}}
                            {{--                                </div>--}}
                            {{--                            </div>--}}
                            @if ($product->added_by == 'seller')
                                <div class="row no-gutters mt-3">
                                    <div class="col-2">
                                        <div class="product-description-label alpha-6">{{__('Seller Guarantees')}}:
                                        </div>
                                    </div>
                                    <div class="col-10">
            ...
            <div class="row">
                <div class="col-xl-3 d-none d-xl-block">
                        ...
                        <div class="sold-by position-relative">
                            ...
                            @if($product->added_by == 'seller' && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                <a href="{{ route('shop.visit', $product->user->shop->slug) }}"
                                   class="name d-block">{{ $product->user->shop->name }}
                                    @if ($product->user->seller->verification_status == 1)
                                    ...
                                    <ul class="social-media social-media--style-1-v4 text-center">
                                        ...
                                        <li>
                                            <a href="{{ $product->user->shop->google }}" class="google" target="_blank"
                                               data-toggle="tooltip" data-original-title="Google">
                    ...
                    <div class="seller-top-products-box bg-white sidebar-box mb-3">
                        <div class="box-title">
                            {{__('Sản phẩm bán chạy nhất trong danh mục này')}}
                        </div>
                        <div class="box-content">
                            @foreach (filter_products(\App\Product::where('category_id', $product->category_id)->orderBy('num_of_sale', 'desc'))->limit(4)->get() as $key => $top_product)
                                <div class="mb-3 product-box-3">
                                    <div class="clearfix">
                                        <div class="product-image float-left">
                                            <a href="{{$top_product->link()}}"
                                               style="background-image:url('{{ asset($top_product->thumbnail_img) }}');"></a>
                                        </div>
                            ...
                            <ul class="nav nav-tabs justify-content-center sticky-top bg-white">
                                <li class="nav-item">
                                    <a href="#tab_default_1" data-toggle="tab"
                                       class="nav-link text-uppercase strong-600 active show">Giới thiệu khóa học</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#tab_default_2" data-toggle="tab"
                                       class="nav-link text-uppercase strong-600">Nội dung khóa học</a>
                                </li>
{{--                                <li class="nav-item">--}}
{{--                                    <a href="#tab_default_3" data-toggle="tab"--}}
{{--                                       class="nav-link text-uppercase strong-600">Thông tin giảng viên</a>--}}
{{--                                </li>--}}
                                <li class="nav-item">
                                    <a href="#tab_default_4" data-toggle="tab"
                                       class="nav-link text-uppercase strong-600">Đánh Giá</a>
                                </li>
                            ...
                            <div class="tab-content pt-0">
                                ...
                                <div class="tab-pane" id="tab_default_2">
                                    <div class="py-2 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                {{--                                                Hiển thị danh sách chương & Bài học--}}
