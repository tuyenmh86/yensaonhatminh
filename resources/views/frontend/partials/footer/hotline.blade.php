	...
	<div class="listSharing_action">
		...
		<ul class="addThis_listing">
			<li class="addThis_item">
				<a class="addThis_item--icon" href="tel:{{ \App\GeneralSetting::first()->phone }}" rel="nofollow" aria-label="phone">
			...
			<li class="addThis_item">
				<a class="addThis_item--icon" href="https://zalo.me/{{\App\GeneralSetting::first()->phone}}" target="_blank" rel="nofollow noreferrer" aria-label="zalo">
					<svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
$( ".addThis_iconContact,.addThis_close" ).on( "click",function() {
