...
<div class="section_flashsale" style="clear:both">
  <div class="container">
    <div class="title">
      <h2 class="title-module">
        <span class="dot"></span> <a href="#" title="sản phẩm làng nghề chổi đót">Sản phẩm chổi đót Thạnh Hoà</a>
      </h2>
    </div>
            ...
            @if($product != null)
              <div class="product-action">
                <div class="product-thumbnail">
                  <a class="image_thumb" href="{{ $product->link() }}" title="{{ $product->title }}">
                    <img class="lazyload" src="{{ asset($product->thumbnail_img) }}"
                      data-src="{{ asset($product->thumbnail_img) }}" alt="{{ $product->description }}"
                  ...
                  <div class="action">
                    ...
                    <a href="javascript:void(0)" class="setWishlist btn-wishlist btn-views"
                      data-wish="{{ $product->id }}" tabindex="0" title="Thêm vào yêu thích"
                      onclick="addToWishList({{ $product->id }})">
                      <i class="fa la la-heart-o"></i>
                    </a>

                    <a title="Xem nhanh" href="{{ $product->link() }}" data-handle="" class="quick-view btn-views"
                      onclick="showAddToCartModal({{ $product->id }})">
                      <i class="la la-eye"></i>
                    </a>
                  </div>
                ...
                <div class="product-info">
                  <h3 class="product-name"><a class="line-clamp line-clamp-2" href="{{ ($product->link()) }}"
                      title="{{ __($product->name) }}">{{ __($product->name) }}</a></h3>
                  <div class="price-box">
