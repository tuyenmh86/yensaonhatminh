    ...
    <div class="container">
            <div class="title">
                <h2 class="title-module">
                    ...
                    <span class="dot"></span> <a href="san-pham-khuyen-mai" title="Khuyến mãi đặc biệt">Khuyến mãi đặc biệt</a>
                </h2>
                <div class="thump-flash">
                    
                    @if($flash_deal != null && strtotime(date('d-m-Y')) >= $flash_deal->start_date && strtotime(date('d-m-Y')) <= $flash_deal->end_date)
                     {{-- || filter_products(\App\Product::where('published', 1)->where('todays_deal', '1'))->count()>0) --}}
                    ...
                    @else
                       <div class="lof-labelexpired"> Chương trình đã kết thúc, hẹn gặp lại trong thời gian sớm nhất!
                       </div>
                   @endif
