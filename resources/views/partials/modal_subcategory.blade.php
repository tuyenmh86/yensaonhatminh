<script type="text/javascript">
    ...
    {
        jQuery('#add_subcategory').modal('show', {backdrop: 'static'});
    }
</script>

<div class="modal fade" id="add_subcategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
