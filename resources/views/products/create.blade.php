...
@section('content')
@include('partials.modal_subcategory')
@include('partials.modal_subsubcategory')
<div class="row">
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group" id="subcategory">
								...
								<a class="badge" onclick="add_subcategory();">Thêm Danh mục con</a>
							</div>
							<div class="form-group" id="subsubcategory">
								...
								<a class="badge" onclick="add_subsubcategory();">Thêm tiểu danh mục</a>
							</div>
...
<script type="text/javascript">
	...
	// function add_more_customer_choice_option() {
	// 	$('#customer_choice_options').append('<div class="form-group"><div class="col-lg-2"><input type="hidden" name="choice_no[]" value="'+i+'"><input type="text" class="form-control" name="choice[]" value="" placeholder="Choice Title"></div><div class="col-lg-5"><input type="text" class="form-control" name="choice_options_'+i+'[]" placeholder="Enter choice values" data-role="tagsinput" onchange="update_sku()"></div><div class="col-lg-2"><input type="file" name="choice_images_'+i+'[]" accept="image/*" onchange="previewImage(this)"></div><div class="col-lg-2"><button onclick="delete_row(this)" class="btn btn-danger btn-icon"><i class="demo-psi-recycling icon-lg"></i></button></div></div>');
	// 	i++;
	// 	$("input[data-role=tagsinput], select[multiple][data-role=tagsinput]").tagsinput();
	// }

	// // Preview the image before uploading (optional)
	// function previewImage(input) {
	// 	if (input.files && input.files[0]) {
	// 		var reader = new FileReader();
	// 		reader.onload = function(e) {
	// 			// Replace the next line with your desired image preview element (e.g., an <img> tag).
	// 			// For example, if you have an <img> tag with ID "preview_image", you can use:
