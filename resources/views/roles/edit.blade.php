            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ __('Post Category') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="14" @php if(in_array(1, $permissions)) echo "checked"; @endphp>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <label class="switch">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="15" @php if(in_array(1, $permissions)) echo "checked"; @endphp>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">Thêm mới học viên</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">Phê duyệt học viên</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
